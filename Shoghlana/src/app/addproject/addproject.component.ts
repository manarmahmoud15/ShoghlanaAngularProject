...
import { FormBuilder, ValidatorFn, FormGroup, FormsModule, ReactiveFormsModule, Validators } from '@angular/forms';
...
export class AddprojectComponent implements OnInit{
  ...
  constructor(private _addprojectService:ApiAddProjectService , private fb: FormBuilder,
    private skillService : SkillsService, private categoryService : CategoryService
  ){
...
console.log(this.categories)
    ...
    this.skillService.GetAll().subscribe({
      next : (res) => {this.skillsIds = res.data
